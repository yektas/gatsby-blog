  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          <svg
            className="fill-current sm:w-6 sm:h-6 mobile:w-5 mobile:h-5 text-gray-500 hover:text-black inline"
        ...
        >
          <svg
            className="fill-current sm:w-6 sm:h-6 mobile:w-5 mobile:h-5 text-gray-500 hover:text-blue-500 inline"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
          >
            <title>Twitter</title>
        ...
        >
          <svg
            className="fill-current sm:w-6 sm:h-6 mobile:w-5 mobile:h-5 text-gray-500 hover:text-blue-600 inline"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
